...
and outputs a b/w image in output folder (deletes previous output folder)
'''
...
for path in paths:
    ...
    print(str(newimage2.filename) + ': ' +  str(percentSelected) +" % within spec")
