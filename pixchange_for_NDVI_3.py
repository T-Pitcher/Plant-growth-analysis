#Status:
#takes a RGNIR image and outputs a greyscale or colour coded image with 5 or 10 bands
#can be equal spacing or equal area
# python pixchange_for_NDVI_3.py
...
savename = "output/" + str(newimage2.filename) + "_output5"+ ".png"
